...
def test_OdgovltHarvester(app, db, mocker):
    ...
    with requests_mock.Mocker() as m:
        ...
        m.register_uri('GET', 'http://127.0.0.1:8983/solr/select/?q=name%3A%227f78728dcfc6-'
            '4f59-aea1-c701fc594ec0%22+OR+id%3A%227f78728d-cfc6-4f59-aea1-c701fc594ec0%22&f'
